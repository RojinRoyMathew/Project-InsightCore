...
GITHUB_TOKEN = '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'  # Replace with your GitHub token
HEADERS = {
...
def fetch_data():
    ...
    try:
       ...
       return render_template("404.html", error_message=f"An error occurred: {str(e)}"), 500
